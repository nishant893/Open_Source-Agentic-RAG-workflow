...
async def analyze_response(llm: Groq, initial_response: str, query: str) -> Dict[str, Any]:
    ...
    messages = [
        ChatMessage(role="system", content="Analyze the initial_response and determine if additional information is needed based on what the query is asking. If so, specify it as a simple, direct question without using any variables or abbreviations. Use natural language to ask for the required information."),
